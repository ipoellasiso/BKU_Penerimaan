...
class Pajakls1Controller extends Controller
{
        ...
        public function index(Request $request)
    {
                        ...
                        if($row->status2 == 'Terima')
                        {
                            $btn = '    <div class="btn-group dropright">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="lihatPajakls dropdown-item" data-id="'.$row->id.'" href="/pajakls1/lihat/'.$row->id.'"">Lihat</a>
                                            </div>
                                        </div>
                                ';
                        }else{
                            ...
                            $btn = '    <div class="btn-group dropright">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="editPajakls1 dropdown-item" data-id="'.$row->id.'" href="/pajakls1/edit/'.$row->id.'">Ubah</a>
                    ...
                    ->addColumn('status2', function($row){
                        if($row->status2 == 'Tolak')
                        {
                            $btn1 = '
                                  ...
                                  <a href="javascript:void(0)" data-id="'.$row->id.'" data-ebilling="'.$row->ebilling.'" data-ntpn="'.$row->ntpn.'" class="terimaPajakls1 btn btn-danger btn-sm"><i class="anticon anticon-dislike"></i> Tolak
                                    </a>
                                  ';
                        }else {
                            $btn1 = '
                                    <a href="javascript:void(0)" data-id="'.$row->id.'" data-ebilling="'.$row->ebilling.'" data-ntpn="'.$row->ntpn.'" class="tolakPajakls1 btn btn-secondary btn-sm"> <i class="anticon anticon-like"></i> Terima
                                    </a>
                                  ';
                        }
                        return $btn1;
        ...
        return view('Penatausahaan.Pajakls1.Tampilpajakls', $data);
    }
    ...
    public function pilihpajaklssipd(Request $request)
    {
        ...
        return view('Penatausahaan.Pajakls1.Tampilpajakls');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($cek_ebilling)
        {
            return redirect('tampilpajakls1')->with(['error'=>'Ebilling sudah ada']);
        }
        elseif($cek_ntppn)
        {
            return redirect('tampilpajakls1')->with(['error'=>'NTPN sudah ada']);
        }
        else
        {
            ...
            // PotonganModel::updateOrCreate(['id' => $pajaklsId_potonganls], $detailspotongan);
            // return response()->json(['success' =>'Data Berhasil Disimpan']);
            return redirect('/tampilpajakls1')->with(['success' =>'Data Berhasil Disimpan']);
    ...
    public function edit($id)
    {
        ...
        return view('Penatausahaan.Pajakls1.Modal.Ubahdata',$data);
    }
    ...
    public function lihat($id)
    {
        ...
        // return response()->json($pajakls);
        return view('Penatausahaan.Pajakls1.Modal.Lihatdata',$data);
    }
    ...
    public function tolaklsupdate(Request $request, string $id)
    {
        ...
        ->update([
            ...
            return redirect('tampilpajakls1')->with('success','Data Berhasil Ditolak');
    }

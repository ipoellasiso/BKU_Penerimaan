...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = array(
            ...
            'tanggaran_rddlholahraga'    => AnggaranModel::join('tb_rekening', 'tb_rekening.id_rekening', 'tb_anggaran.id_rekening')->where('tb_rekening.no_rekening', '4.1.02.01.02.0001a')->sum('nilai'),
            ...
            'total_rddlholahraga'    => bkusModel::join('tb_rekening', 'tb_rekening.id_rekening', 'tb_transaksi.id_rekening')->where('tb_rekening.no_rekening', '4.1.02.01.02.0001a')->sum('nilai_transaksi'),
